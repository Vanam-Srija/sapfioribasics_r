		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData Practice",
									"targetURL": "#comustnorthwindnwpractice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comustnorthwindnwpractice-display": {
								"semanticObject": "comustnorthwindnwpractice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ust.northwind.nwpractice",
									"url": sap.ui.require.toUrl("com/ust/northwind/nwpractice")
								}
							}
						}
					}
